(function () {
  ...
  var template = '<md-dialog class="dtp" layout="column" style="width: 300px;">'
    ...
    + '        </div>'
    + '    </md-dialog-content>'
    + '    <md-dialog-actions class="dtp-buttons layout-align-space-around">'
    + '            <md-button class="md-raised dtp-btn-ok md-button" ng-click="picker.today()" ng-if="picker.isDateOfTheDay()"> {{picker.params.todayText}}</md-button>'
    + '            <md-button class="md-raised md-warn dtp-btn-cancel md-button" ng-click="picker.cancel()"> {{picker.params.cancelText}}</md-button>'
    + '            <md-button class="md-raised dtp-btn-ok md-button" ng-click="picker.ok()"> {{picker.params.okText}}</md-button>'
    + '      </md-dialog-actions>'
    + '</md-dialog>';
        ...
        return {
          ...
          link: function (scope, element, attrs, ngModel) {
            ...
            element.on('focus', function (e) {
              ...
              if (typeof scope.currentDate == 'string') {
                  scope.currentDate = moment(scope.currentDate, scope.format);
              }
